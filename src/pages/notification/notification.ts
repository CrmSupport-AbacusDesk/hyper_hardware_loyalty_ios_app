...
export class NotificationPage {
    ...
    lang:any='';
    karigar_id:any="";
    kariger_id_notifications:any;
    loading:any
    constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,private app:App,public service:DbserviceProvider,public storage:Storage,public translate:TranslateService) {
        this.get_user_lang();
        ...
        .then(resp=>{
            ...
            this.kariger_id_notifications = this.service.karigar_id
            console.log ("1",this.kariger_id_notifications );
