      ...
      recvConfirmation()
      {
        let alert=this.alertCtrl.create({
          ...
          },
          {
            ...
            handler:()=>
            {
              this.service.post_rqst({'id':this.karigar_gift_id,'karigar_id':this.service.karigar_id},'app_karigar/redeemReceiveStatus').subscribe(r=>
                {
                  console.log(r);
                  this.showSuccess('You have receive amount successfully')
