...
export class GiftDetailPage {
    ...
    presentCancelPolicyModal() {
        if(this.offer_balance < this.gift_detail.coupon_points){
            ...
            let contactModal = this.modalCtrl.create(CancelpolicyModalPage,{'mode':'NotreedeemPoint','needPoint':this.needPoint});
            contactModal.present();
            console.log('otp');
            
        }
    }
    presentCancelPolicyModal1(){
        console.log('====================================');
        ...
        // contactModal.present();
        // console.log('otp');
        this.navCtrl.push(CancelpolicyModalPage,{'karigar_id':this.service.karigar_id,'gift_id':this.gift_id,"mode":"reedeemPoint", 'offer_balance':this.offer_balance})
    }
    ...
    getGiftDetail(gift_id)
    {
        ...
        .subscribe( (r) =>
        {
            ...
            this.needPoint =  this.gift_detail.coupon_points -  this.offer_balance
            console.log("need point ============>",this.needPoint);
